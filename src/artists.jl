...
"""
function ScalebarArtist(scales; target_ax_frac=0.25, muls=[x*p for p in Real[1e-9, 1e-8, 1e-7, 1e-5, 1e-4, 1e-3, 0.01, 0.1, 1, 10, 100, 1000, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9] for x in [1, 2, 5]], ax=plt.gca(), color=:k, loc="lower center", sep=2.5)
